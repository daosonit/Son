    ...
    <div class="container content-md">
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                            ...
                            <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus
                                tellus, imperdiet molestie est volutpat at. Sed viverra cursus nibh, sed consectetur
                                ipsum sollicitudin non metus inmi efficitur...</p>
                ...
                <div class="row margin-bottom-20">
                    <div class="col-sm-5 sm-margin-bottom-20">
                        <img class="img-responsive" src="website/img/main/img18.jpg" alt="">
                    </div>
                    <div class="col-sm-7 news-v3">
                        <div class="news-v3-in-sm no-padding">
                            <ul class="list-inline posted-info">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-inline blog-photostream margin-bottom-50">
                    <li>
                        <a href="website/img/main/img22.jpg" rel="gallery" class="fancybox img-hover-v2"
                           title="Image 1">
                            <span><img class="img-responsive" src="website/img/main/img22.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img23.jpg" rel="gallery" class="fancybox img-hover-v2"
                           title="Image 2">
                            <span><img class="img-responsive" src="website/img/main/img23.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img4.jpg" rel="gallery" class="fancybox img-hover-v2" title="Image 3">
                            <span><img class="img-responsive" src="website/img/main/img4.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img9.jpg" rel="gallery" class="fancybox img-hover-v2" title="Image 4">
                            <span><img class="img-responsive" src="website/img/main/img9.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img25.jpg" rel="gallery" class="fancybox img-hover-v2"
                           title="Image 5">
                            <span><img class="img-responsive" src="website/img/main/img25.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img6.jpg" rel="gallery" class="fancybox img-hover-v2" title="Image 6">
                            <span><img class="img-responsive" src="website/img/main/img6.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img20.jpg" rel="gallery" class="fancybox img-hover-v2"
                           title="Image 7">
                            <span><img class="img-responsive" src="website/img/main/img20.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img3.jpg" rel="gallery" class="fancybox img-hover-v2" title="Image 8">
                            <span><img class="img-responsive" src="website/img/main/img3.jpg" alt=""></span>
                        </a>
                    </li>
                    <li>
                        <a href="website/img/main/img7.jpg" rel="gallery" class="fancybox img-hover-v2" title="Image 9">
                            <span><img class="img-responsive" src="website/img/main/img7.jpg" alt=""></span>
                        </a>
                    </li>
                </ul>
                <!-- End Photostream -->
